...
public class RigidFixutre extends Component implements IContact {
	 ...
	 * @param offset
	 * @param vertices
	 *            the vertices in term of pixel, for example, (16,80), check in
	 *            paint.net
	 * @param spriteSize
	 *            the sprite size of the sprite, example, 160x160 pixels
	 * @param rotation
	 *            this rotation only means the rotation with respect to the
	 *            parent rigidBody
	 * 
